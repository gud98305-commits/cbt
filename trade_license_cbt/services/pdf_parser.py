...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "11. PDF에서 추출된 한국어 텍스트는 띄어쓰기가 누락되어 있을 수 있다. "
        "question_text, context, options의 모든 한국어 텍스트에 올바른 띄어쓰기를 적용하라. "
        "예: '피보험자의의무내용에대한설명' → '피보험자의 의무 내용에 대한 설명'.\n"
        "12. 지문(context)을 반드시 정확히 추출하라. 시험 문제에서 지문이란 문제 앞에 제시되는 참고 텍스트로, "
        "보기·표·사례·조문·영문 지문·계약서 조항·상황 설명 등이 해당된다. "
